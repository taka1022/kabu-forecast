            ...
            <Card style={{padding:mobile?"14px 6px 8px 0":"20px 16px 10px 0",marginBottom:14}}>
              ...
              <ResponsiveContainer width="100%" height={mobile?200:280}>
                <AreaChart data={chart} margin={{top:5,right:mobile?4:10,left:mobile?0:10,bottom:5}}>
                  ...
                  <XAxis dataKey="date" tick={{fontSize:mobile?8:10,fill:"#AAA",fontFamily:"DM Mono"}} axisLine={{stroke:"var(--border-light)"}} tickLine={false} interval={xInterval}/>
                  <YAxis domain={[pMin,pMax]} tick={{fontSize:mobile?8:10,fill:"#AAA",fontFamily:"DM Mono"}} axisLine={false} tickLine={false} tickFormatter={(v:number)=>`¥${Math.round(v).toLocaleString()}`} width={mobile?55:78}/>
